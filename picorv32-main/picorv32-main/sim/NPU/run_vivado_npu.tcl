...
if {[file exists ".sim/xsim_npu"]} {
    file delete -force ".sim/xsim_npu"
}
file mkdir ".sim/xsim_npu"

puts "INFO: xvlog compile..."
eval xvlog -sv $rtl_list

puts "INFO: xelab..."
xelab -debug typical -s tb_npu_core_tile_4x4_sim tb_npu_core_tile_4x4

puts "INFO: xsim run..."
if {$run_gui} {
    xsim tb_npu_core_tile_4x4_sim -gui
} else {
    xsim tb_npu_core_tile_4x4_sim -runall
}
